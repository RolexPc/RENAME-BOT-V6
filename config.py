...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6806770075:AAHr-z1o-rZWDj2zhpqNZ3JOTakwcBwoSEE")  # ⚠️ Required
    ...
    # database config
    DB_NAME = os.environ.get("DB_NAME", "Renamebotv6")
    DB_URL = os.environ.get("DB_URL", "mongodb+srv://Renamebotv6:Renamebotv6@cluster0.xuqjwfh.mongodb.net/")  # ⚠️ Required
